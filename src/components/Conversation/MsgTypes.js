    ...
    return (
        <Stack direction="row" justifyContent={el.incoming ? "start" : "end"}>
            <Box p={1.5} sx={{ backgroundColor: el.incoming ? theme.palette.default : theme.palette.primary.main, borderRadius: 1.5, width: "max-content", }} >
                <Stack spacing={2}>
                    <Stack p={2} direction="row" spacing={3} alignItems="cemter" sx={{ backgroundColor: theme.palette.background.paper, borderRadius: 1 }}>
                        <Image size={48} />
...
const LinkMsg = ({ el }) => {
    ...
    return (
        <Stack direction="row" justifyContent={el.incoming ? "start" : "end"}>
            <Box p={1.5} sx={{ backgroundColor: el.incoming ? theme.palette.default : theme.palette.primary.main, borderRadius: 1.5, width: "max-content", }} >
                <Stack spacing={2}>
                    <Stack p={2} spacing={3} alignItems="start" direction="column" sx={{ backgroundColor: theme.palette.background.paper, borderRadius: 1 }}>
